...
A toolkit of modern [dotnet new templates](https://docs.microsoft.com/en-us/dotnet/core/tools/dotnet-new) for C# 14, .NET 10, Microsoft Orleans 10, Windows App SDK and Uno Platform 5.6
